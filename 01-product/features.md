...
| F11 | Parent gate and settings | Gate that kids can't pass; language, unlock all, reset, coach on/off | Must | F08, F09, F10 |
...
| F16 | Sound effects | Move, capture, check and result sounds; mute option (deferred: owner wants no sound for now) | Nice (later) | F02 |
