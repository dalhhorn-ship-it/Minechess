...
2. They prefer moves that walk their king toward the child's pieces, so checkmate is easier to find.
3. They **resign** once they have been down 9 or more points of material after each of 3 of their own moves in a row. Resigning is a legal chess result: the child wins, and the creature plays a big sad animation.
