...
**Round 6 (owner): 8 extra creatures, built.** Four very easy ones for the youngest (1 star, they help the child win like Wobble and Clucky): Snurk the Sleepy Sheep (dozes off and shuffles the same piece), Plons the Jumping Frog (loves knight jumps), Fizz the Fizzy Block (grabs anything and charges into traps) and Muddle the Mole (forgets plans). Four a bit smarter ones: Knor the golden Piggy Bank (2 stars, greedy, always takes the biggest piece), Stip the Ladybird (2 stars, attacks and loves giving check), IJzerwachter the Iron Guardian (3 stars, defensive) and Kristal the Owl (3 stars, patient, sometimes looks two moves ahead). All 11 creatures are open on the start screen in two rows. Easy creatures also never take the child's last winning material, so games against them don't end in a bare kings draw. The ladder above stays the long term plan for Triple Shade and Deep Watcher.
